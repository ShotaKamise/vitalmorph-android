...
object HumanoidRoster {
    ...
    private val lines: Map<HumanoidJob, JobLine> = mapOf(
        HumanoidJob.SWORDSMAN to JobLine(
            matureOf("leon_saber_m", "レオンセイバー", HumanoidJob.SWORDSMAN, "調和の取れた生活から生まれた若き剣士。", GREEN),
            finalOf("sol_regnard_m", "ソルレグナード", HumanoidJob.SWORDSMAN, "太陽の剣で仲間を守り抜く剣王。", GREEN),
            matureOf("valeria_f", "ヴァレリア", HumanoidJob.SWORDSMAN, "均整の取れた鍛錬を積み重ねる女性剣士。", GREEN),
            finalOf("val_rose_f", "ヴァルローゼ", HumanoidJob.SWORDSMAN, "薔薇の剣舞で戦場を制する剣姫。", GREEN),
        ),
        ...
        HumanoidJob.GREATSWORD to JobLine(
            matureOf("grand_breaker_m", "グランブレイカー", HumanoidJob.GREATSWORD, "鍛え上げた筋力で大剣を振るう戦士。", RED),
            finalOf("titan_glaive_m", "タイタングレイヴ", HumanoidJob.GREATSWORD, "巨人の名を冠する大剣の覇者。", RED),
            matureOf("crim_arge_f", "クリムアージュ", HumanoidJob.GREATSWORD, "紅の大剣を軽々と操る女戦士。", RED),
            finalOf("grand_empress_f", "グランエンプレス", HumanoidJob.GREATSWORD, "戦場に君臨する大剣の女帝。", RED),
        ),
        HumanoidJob.LANCER to JobLine(
            matureOf("volt_lancer_m", "ヴォルトランサー", HumanoidJob.LANCER, "運動の熱を雷の槍へ変える槍兵。", PURPLE),
            finalOf("tempest_dragoon_m", "テンペストドラグーン", HumanoidJob.LANCER, "嵐を纏い空を駆ける竜騎士。", PURPLE),
            matureOf("celes_lancer_f", "セレスランサー", HumanoidJob.LANCER, "天空の槍を操る俊敏な槍使い。", PURPLE),
            finalOf("astra_reina_f", "アストラレイナ", HumanoidJob.LANCER, "星の槍で天を貫く槍の女王。", PURPLE),
        ),
        HumanoidJob.GUNNER to JobLine(
            matureOf("barrel_guard_m", "バレルガード", HumanoidJob.GUNNER, "あふれる活動エネルギーを弾丸に込める銃士。", ORANGE),
            finalOf("arc_buster_m", "アークバスター", HumanoidJob.GUNNER, "電光の砲撃で戦場を薙ぎ払う重銃士。", ORANGE),
            matureOf("rouge_shell_f", "ルージュシェル", HumanoidJob.GUNNER, "紅の散弾で敵を寄せ付けない銃使い。", ORANGE),
            finalOf("nova_valeria_f", "ノヴァバレリア", HumanoidJob.GUNNER, "新星の砲火を操る銃の女傑。", ORANGE),
        ),
        HumanoidJob.MAGE to JobLine(
            matureOf("rune_sage_m", "ルーンセージ", HumanoidJob.MAGE, "静かな暮らしから魔力を紡ぐ賢者。", YELLOW),
            finalOf("astra_magius_m", "アストラマギウス", HumanoidJob.MAGE, "星々の魔導を極めた大魔導士。", YELLOW),
            matureOf("mystica_f", "ミスティカ", HumanoidJob.MAGE, "穏やかな休息を魔法の泉に変える魔女。", YELLOW),
            finalOf("eclipsia_f", "エクリプシア", HumanoidJob.MAGE, "月蝕の魔力を操る大魔女。", YELLOW),
        ),
